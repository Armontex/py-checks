...
<img src="../logo.svg" width="112" alt="py-checks">
...
- **Чужую работу мы не делаем.** Что умеют ruff, pyright и import-linter — остаётся за ними; что и почему туда отдано, записано в [`service.ru.md`](service.ru.md).
...
лежит в [`service.ru.md`](service.ru.md).
