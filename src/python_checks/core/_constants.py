...
# Группа для правил, которым нужен не файл исходника, а проект целиком:
# манифест, файлы репозитория, их согласие между собой.
PROJECT_GROUP: Final = "python_checks.project_checks"
